...
const About: React.FC = () => {
  return (
    <section id="about" className="py-16 lg:py-24 bg-off-white">
      ...
      {/* Professional Credentials - Full Width Section */}
      <div className="bg-off-white py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="heading-serif text-3xl md:text-4xl lg:text-5xl text-charcoal mb-6 text-center">
            <span className="italic text-sage-green">Professional</span> Accreditations
          </h3>
          <p className="text-secondary font-light text-center mb-12 max-w-2xl mx-auto text-base sm:text-lg lg:text-xl leading-relaxed">
